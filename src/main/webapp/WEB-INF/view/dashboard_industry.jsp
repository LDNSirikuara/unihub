                                    ...
                                    <div class="about-content col-lg-12">
                                            ...
                                            <div class="link-nav">
                                                    <span class="box">
                                                            ...
                                                            <a href="industryprofile.html">industry</a>
                                                    </span>
                                            </div>
                                    </div>
                            </div>
                                            ...
                                            <div class="single-cat-widget">
                                                    <div class="content relative">
                                                            ...
                                                            <a href="#" target="_blank">
                                                                    <div class="thumb">
                                                                            <img class="content-image img-fluid d-block mx-auto" src="../src/img/blog/internship.jpg" alt="">
    <!--									<label><a href="editIndustryPro.html">edit profile</a></label><br>-->

    <!--									<label>Omobio (Pvt) Limited</label><br>-->

                                                                    </div>
                                                                    <div class="content-details">
                                                                    <h4 class="content-title mx-auto text-uppercase">Internship</h4>
                                                                    <span></span>
                                                                            <p>join with us</p>
                                                                    </div>
                                                            </a>
                                    ...
                                    <div class="col-lg-4">
                                            <div class="single-cat-widget">
                                                    <div class="content relative">
                                                            ...
                                                            <a href="#" target="">
                                                                    <div class="thumb">
                                                                            <img class="content-image img-fluid d-block mx-auto" src="../src/img/blog/workshop.jpg" alt="">
                                                                    </div>
                                                                    <div class="content-details">
                                                                            <h4 class="content-title mx-auto text-uppercase">Workshops</h4>
                                                                            <span></span>
                                                                            <p>build skils personal development</p>
                                                                    </div>
                                                            </a>
                                                    </div>
                                            </div>
                                    ...
                                    <div class="col-lg-4">
                                            <div class="single-cat-widget">
                                                    <div class="content relative">
                                                            ...
                                                            <a href="#" target="_blank">
                                                                    <div class="thumb">
                                                                            <img class="content-image img-fluid d-block mx-auto" src="../src/img/blog/research.jpg" alt="">
                                                                    </div>
                                                                    <div class="content-details">
                                                                            <h4 class="content-title mx-auto text-uppercase">Research project</h4>
                                                                            <span></span>
                                                                            <p>can you help us?</p>
                                                                    </div>
                                                            </a>
                    ...
                    <div class="row">
                        <div class="col-lg-8 posts-list">
                            <div class="comment-form">
                                <h4>Upload Research or events</h4>
                                <form action="/uniHub/addPost" enctype="multipart/form-data" method="POST">
                                                    ...
                                                    <div class="container">
                                                            <div class="row align-items-center justify-content-center">
                                                                    ...
                                                                    <div class="offset-lg-1 col-lg-6 offset-md-0 col-md-12 about-right">
                                                                            ...
                                                                            <a  class="genric-btn info-border circle">${c.iName}</a>
                                                                            <c:if test="${c.pTag == 1 }">
                                    ...
                                    <div class="col-lg-4 sidebar-widgets">
                                            <div class="widget-wrap">
                                                    ...
                                                    <div class="single-sidebar-widget user-info-widget">
                                                            <img src="../src/img/blog/industry.jpg" alt="">
                                                    ...
                                                    <div class="single-sidebar-widget popular-post-widget">
                                                            ...
                                                            <div class="popular-post-list">
                                                                    ...
                                                                    <div class="single-post-list d-flex flex-row align-items-center">
                                                                            ...
                                                                            <div class="details">
                                                                                    <a href="#"><h6>The Amazing Hubble</h6></a>
                                                                                    <p>02 Hours ago</p>
                                                                            </div>
                                                                    </div>
                                                                    <div class="single-post-list d-flex flex-row align-items-center">
                                                                            ...
                                                                            <div class="details">
                                                                                    <a href="#"><h6>Astronomy Or Astrology</h6></a>
                                                                                    <p>02 Hours ago</p>
                                                                            </div>
                                                                    </div>
                                                                    <div class="single-post-list d-flex flex-row align-items-center">
                                                                            ...
                                                                            <div class="details">
                                                                                    <a href="#"><h6>Asteroids telescope</h6></a>
                                                                                    <p>02 Hours ago</p>
                                                                            </div>
                                                                    </div>
                                                            </div>
                                                    ...
                                                    <div class="single-sidebar-widget post-category-widget">
                                                            ...
                                                            <ul class="cat-list">
                                                                            <li>
                                                                                            <a href="universityprofile" class="d-flex justify-content-between">
                                                                                                    <p>University</p>
                                                                                                    <p>37</p>
                                                                                            </a>
                                                                                    </li>
                                                                                    <li>
                                                                                            <a href="event.html" class="d-flex justify-content-between">
                                                                                                    <p>University Events</p>
                                                                                                    <p>24</p>
                                                                                            </a>
                                                                                    </li>
                                                                                    <li>
                                                                                            <a href="industryprofile" class="d-flex justify-content-between">
                                                                                                    <p>Company</p>
                                                                                                    <p>59</p>
                                                                                            </a>
                                                                                    </li>
                                                                                    <li>
                                                                                            <a href="research.html" class="d-flex justify-content-between">
                                                    ...
                                                    <div class="single-sidebar-widget tag-cloud-widget">
                                                            ...
                                                            <ul>
                                                                            <li><a href="universityprofile.html">University</a></li>
                                                                            <li><a href="event.html">University Events</a></li>
                                                                            <li><a href="industryprofile">Companies</a></li>
